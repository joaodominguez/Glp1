...
const staticRoutes: Array<{
  ...
  { path: "/nauseas/", changeFrequency: "monthly", priority: 0.78 },
  { path: "/dose-esquecida/", changeFrequency: "monthly", priority: 0.78 },
  { path: "/gravidez/", changeFrequency: "monthly", priority: 0.78 },
  { path: "/pilula/", changeFrequency: "monthly", priority: 0.75 },
  { path: "/comprar-online/", changeFrequency: "monthly", priority: 0.75 },
  { path: "/mounjaro-vs-ozempic/", changeFrequency: "monthly", priority: 0.82 },
  { path: "/sobre/", changeFrequency: "monthly", priority: 0.55 },
  { path: "/privacidade/", changeFrequency: "yearly", priority: 0.4 },
  { path: "/sugerir/", changeFrequency: "yearly", priority: 0.35 },
